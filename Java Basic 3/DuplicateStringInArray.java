//To find the duplicates of array of strings

import java.util.Arrays;

class DuplicateStringInArray{

	public static void main(String[] args){

		String[] a = {"hi","bye","hello","good","hi","bye","ok"};	//original array
		String[] dup =  new String[7];	//array to copy duplicate values
		int i,j;
